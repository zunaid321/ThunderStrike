...
const NVRAM_LENS_PARA_STRUCT DUMMY_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        { 0, // i4Offset
          ...
          0,  // i4FV_CHANGE_THRES;
          0,  // i4FV_CHANGE_OFFSET;        
          0,  // i4FV_CHANGE_CNT;
          0,  // i4GS_CHANGE_THRES;    
          0,  // i4GS_CHANGE_OFFSET;    
          0,  // i4GS_CHANGE_CNT;            
          0,  // i4FV_STABLE_THRES;         // percentage -> 0 more stable  
          0,  // i4FV_STABLE_OFFSET;        // value -> 0 more stable
          0,  // i4FV_STABLE_NUM;           // max = 9 (more stable), reset = 0
          0,  // i4FV_STABLE_CNT;           // max = 9                                      
          0,  // i4FV_1ST_STABLE_THRES;        
          0,  // i4FV_1ST_STABLE_OFFSET;
          0,  // i4FV_1ST_STABLE_NUM;                        
          0  // i4FV_1ST_STABLE_CNT;      
         },
        ...
        // --- sAF_TH ---
         ...
         // --- sZSDAF_TH ---
          ...
          {
              { 0,   0,   0,   0,   0}, // back to bestpos step
